package com.kedacom.xlite.sys.core.cache;

import cn.hutool.cache.impl.TimedCache;
import com.kedacom.xlite.sys.core.cache.base.AbstractMemoryCacheOperator;
...
public class MappingCache extends AbstractMemoryCacheOperator<Map<String, Object>> {
     ...
     * 缓存的前缀标识
     */
    public static final String TRANSLATES_CACHE_PREFIX = "";
